...
function bootstrap_cli::parse() {
  ...
  local use_ci_runtime="false"
  local ci_runtime_python=""
  ...
  bootstrap_config::set "$config_name" use_ci_runtime "$use_ci_runtime"
  bootstrap_config::set "$config_name" ci_runtime_python "$ci_runtime_python"
