...
This guide explains Rucio's metadata features for both users and administrators, covering the plugin system, configuration, filtering, and the available interfaces.
