...
def test_runtime_dockerfile_pins_every_supported_python() -> None:
    ...
    assert "FROM almalinux:10.2 AS base" in dockerfile
    ...
    assert 'ARG MOD_WSGI_VERSION="5.0.2"' in dockerfile
    assert 'ARG MOD_WSGI_SHA256="9a0fdb61405abc300ec6b100c440dd98cf31cb5f97aeef4207390937298cad20"' in dockerfile
    assert '"${MOD_WSGI_SHA256}  mod_wsgi-${MOD_WSGI_VERSION}.tar.gz"' in dockerfile
